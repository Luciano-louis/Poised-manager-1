...
public class Poised {
	public static void main (String [] args)throws IOException {
		...
		if(User_selection.equals("New Project")) {
		...
		else if(User_selection.equals("View projects")) {
			System.out.println("Current list of Projects: \n");
			
			
			ArrayList<String> Taskfix = new ArrayList<String>();		
			try {
				File text = new File ("Tasks.txt");//open text file beung referenced
		...
		else if(User_selection.equals("Update Date")) {
			String Switch;
		...
		else if(User_selection.equals("Update Amount")) {
			String Switch;
			ArrayList<String> Replace = new ArrayList<String>();	
			System.out.println("Please enter the Project Number:");
			Scanner z1 = new Scanner(System.in);
			...
			try {
				...
				else if(User_selection.equals("New customer")) {
			...
			else if(User_selection.equals("View Customers")) {
			...
			else if(User_selection.equals("New Achitect")) {
		    ...
		    fr.close();
			...
			else if(User_selection.equals("View Achitects")) {
				...
				else if(User_selection.equals("New Contractor")) {
				...
				else if(User_selection.equals("View Contractors")) {
					System.out.println("Current customer details: \n");
					try {
				...
				else if(User_selection.equals("Update Contractor")) {
					String Switch;
					ArrayList<String> Replace = new ArrayList<String>();	
				...
				else if(User_selection.equals("Finalise")) {
					System.out.println("Please enter the Project number You would like to finalise:");
